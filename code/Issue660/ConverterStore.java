...
public final class ConverterStore {
  private static final ConditionalConverter<?, ?>[] DEFAULT_CONVERTERS = new ConditionalConverter<?, ?>[] {
          ...
          new AssignableConverter(), new StringConverter(), new EnumConverter(),
          new NumberConverter(), new BooleanConverter(), new CharacterConverter(),
          // CS304 Issue link:  https://github.com/modelmapper/modelmapper/issues/660
          new DateConverter(), new CalendarConverter(), new UuidConverter(),
  };
